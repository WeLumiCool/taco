            ...
            <div class="row choice-list">
                @foreach($cases as $case)
                    <div class="col-3 p-2">
                        ...
                        <p class="font-size-14 text-center roboto font-weight-light mt-1">Цена за пост: {{$case->price}} сом</p>
                        <div class="text-center">
                            <a href="{{ route('tiktok',$case->advertiser->id) }}">
