                    ...
                    <div class="row">
                        <div class="col-lg-4 col-12">
                            <div class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <a class="w-100" id="profile-tab" data-toggle="tab" href="#wait" role="tab" aria-controls="profile" aria-selected="false">
                                        <button class="btn taco-btn-2 w-100 mb-3 py-2 font-size-12">
                                            Ожидают подтверждения
                                        </button>
                                    </a>
                                    <a class="w-100" id="contact-tab" data-toggle="tab" href="#active" role="tab" aria-controls="contact" aria-selected="false">
                                        <button class="btn taco-btn-2 w-100 mb-3 py-2 font-size-12">
                                            Активные кампании
                                        </button>
                                    </a>
                                <a class="w-100" id="contact-tab" data-toggle="tab" href="#close" role="tab" aria-controls="contact" aria-selected="false">
                                    <button class="btn taco-btn-2 w-100 mb-3 py-2 font-size-12">
                                        Завершенные
                                    </button>
                                </a>
                                ...
                                <div class="tab-pane fade" id="wait" role="tabpanel" aria-labelledby="profile-tab">
                                    ...
                                    @foreach($advs as $adv)
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-12">
                                                <p class="font-size-16 mb-0">
                                                    {{ \App\User::find($adv->advertiser_id)->name }}
                                                </p>
                                            </div>
                                            <div class="col-lg-3 col-12">
                                                <p class="font-size-16 mb-0">
