            ...
            <div class="col-4" style="transform: translateY(-24px);">
                <div class="form-group small mt-0 mb-0">
                    ...
                    <select type="text" name="type" id="type" class="browser-default custom-select">
                        ...
                        <option value="Рекламная интеграция с выездом">Рекламная интеграция с выездом</option>
                        <option value="Рекламная интеграция без выезда">Рекламная интеграция без выезда</option>
                        <option value="Размещение ролика">Размещение ролика</option>
                    </select>
                </div>
            </div>
            <div class="col-2">
                ...
                @foreach($cases as $case)
                    <div class="col-3 p-2">
                        ...
                        <div class="py-2  shadow-sm">
                            ...
                            <p class="font-size-16 text-center roboto font-weight-light mt-1">{{$case->name}}</p>
                            <p class="font-size-14 text-center roboto font-weight-light mt-1">Цена: {{$case->price}}$</p>
                            <div class="text-center">
                                <a href="{{ route('youtube',$case->advertiser->id) }}">
